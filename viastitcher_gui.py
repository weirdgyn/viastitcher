...
class viastitcher_gui ( wx.Dialog ):
	...
	def __init__( self, parent ):
		...
		fgSizer1.Add( self.m_chkRandomize, 0, wx.ALIGN_CENTER_VERTICAL|wx.ALL, 5 )
		...
		fgSizer1.Add( self.m_lblNetName, 0, wx.ALIGN_CENTER_VERTICAL|wx.ALIGN_LEFT|wx.ALL, 5 )
		...
		fgSizer1.Add( self.m_lblViaParams, 0, wx.ALIGN_CENTER_VERTICAL|wx.ALL, 5 )
		...
		fgSizer1.Add( self.m_lblUnit1, 0, wx.ALIGN_CENTER_VERTICAL|wx.ALL, 5 )
		...
		fgSizer1.Add( self.m_lblSpacing, 0, wx.ALIGN_CENTER_VERTICAL|wx.ALL, 5 )
		...
		fgSizer1.Add( self.m_lblUnit2, 0, wx.ALIGN_CENTER_VERTICAL|wx.ALL, 5 )

		self.m_lblOffset = wx.StaticText( self, wx.ID_ANY, _(u"Offset (V/H)"), wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_lblOffset.Wrap( -1 )

		fgSizer1.Add( self.m_lblOffset, 0, wx.ALIGN_CENTER_VERTICAL|wx.ALL, 5 )
		...
		fgSizer1.Add( self.m_lblUnit3, 0, wx.ALIGN_CENTER_VERTICAL|wx.ALL, 5 )
		...
		fgSizer1.Add( self.m_lblClearance, 0, wx.ALIGN_CENTER_VERTICAL|wx.ALL, 5 )
		...
		fgSizer1.Add( self.m_lblUnit4, 0, wx.ALL, 5 )
		...
		bSizer1.Add( self.m_chkOnlyFilledCopper, 0, wx.ALIGN_CENTER_HORIZONTAL|wx.ALL, 5 )
		...
		bSizer1.Add( self.m_chkClearOwn, 0, wx.ALIGN_CENTER_VERTICAL|wx.ALL, 5 )
